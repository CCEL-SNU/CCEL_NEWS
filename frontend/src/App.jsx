...
function WeeklyDigest({digest,papers,bms,onBm,groups}){
  if(!digest)return null;
    ...
    <div style={{maxWidth:980,margin:"0 auto",padding:"20px 20px 0"}}>
      ...
      {view==="landscape"&&<div>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:14}}>
          <div id="landscape-weekly-digest" className="ccel-landscape-section"><WeeklyDigest digest={digest} papers={papers} bms={bms} onBm={toggleBm} groups={allGroups}/></div>
